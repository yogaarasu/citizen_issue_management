...
export const RegisterPage: React.FC = () => {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
        await sendOtpToEmail(formData.email.trim().toLowerCase(), true); // true = isRegistration
  ...
  const handleVerifyAndRegister = async () => {
      ...
      try {
          ...
          // Create user directly (OTP verification happens in backend)
          await createUser({
        ...
        {!showOtpModal ? (
            ...
            <div className="space-y-6">
                <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Check your email for the verification code</p>
                </div>
